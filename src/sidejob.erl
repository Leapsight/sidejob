...
call({Name, Key}, Msg, Timeout) ->
    ...
    case is_available(WorkerETS, Limit, Worker - 1) of
        true ->
            gen_server:call(worker_reg_name(Name, Worker - 1), Msg, Timeout);
        false ->
            overload
    end;
...
cast({Name, Key}, Msg) ->
    ...
    case is_available(WorkerETS, Limit, Worker - 1) of
        true ->
            gen_server:cast(worker_reg_name(Name, Worker - 1), Msg);
        false ->
            overload
    end;
